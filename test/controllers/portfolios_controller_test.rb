...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { about: @portfolio.about, cv: @portfolio.cv, image: @portfolio.image, is_employed: @portfolio.is_employed } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { about: @portfolio.about, cv: @portfolio.cv, image: @portfolio.image, is_employed: @portfolio.is_employed } }
